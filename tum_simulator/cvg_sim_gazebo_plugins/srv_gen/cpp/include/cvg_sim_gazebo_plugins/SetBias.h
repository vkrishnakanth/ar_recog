/* Auto-generated by genmsg_cpp for file /home/krishna/fuerte_workspace/sandbox/tum_simulator/cvg_sim_gazebo_plugins/srv/SetBias.srv */
#ifndef CVG_SIM_GAZEBO_PLUGINS_SERVICE_SETBIAS_H
#define CVG_SIM_GAZEBO_PLUGINS_SERVICE_SETBIAS_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
{
template<class ContainerAllocator> struct IsMessage< ::cvg_sim_gazebo_plugins::SetBiasRequest_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::cvg_sim_gazebo_plugins::SetBiasRequest_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
...
template<class ContainerAllocator> struct IsFixedSize< ::cvg_sim_gazebo_plugins::SetBiasRequest_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
...
namespace message_traits
{
template<class ContainerAllocator> struct IsMessage< ::cvg_sim_gazebo_plugins::SetBiasResponse_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::cvg_sim_gazebo_plugins::SetBiasResponse_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
...
template<class ContainerAllocator> struct IsFixedSize< ::cvg_sim_gazebo_plugins::SetBiasResponse_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
...
#endif // CVG_SIM_GAZEBO_PLUGINS_SERVICE_SETBIAS_H
