...
(cl:defmethod cl:initialize-instance :after ((m <Altimeter>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Altimeter)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cvg_sim_msgs-msg:<Altimeter> is deprecated: use cvg_sim_msgs-msg:Altimeter instead.")))
...
(cl:defmethod pressure-val ((m <Altimeter>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cvg_sim_msgs-msg:pressure-val is deprecated.  Use cvg_sim_msgs-msg:pressure instead.")
  (pressure m))
