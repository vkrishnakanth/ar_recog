...
(cl:defclass <Supply> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass Supply (<Supply>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <Supply>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'Supply)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cvg_sim_msgs-msg:<Supply> is deprecated: use cvg_sim_msgs-msg:Supply instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Supply>))
...
(cl:defmethod voltage-val ((m <Supply>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cvg_sim_msgs-msg:voltage-val is deprecated.  Use cvg_sim_msgs-msg:voltage instead.")
  (voltage m))

(cl:ensure-generic-function 'current-val :lambda-list '(m))
(cl:defmethod current-val ((m <Supply>))
  ...
  (current m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Supply>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Supply>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Supply>)))
  "Returns string type for a message object of type '<Supply>"
  "cvg_sim_msgs/Supply")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Supply)))
  "Returns string type for a message object of type 'Supply"
  "cvg_sim_msgs/Supply")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Supply>)))
  "Returns md5sum for a message object of type '<Supply>"
  "26f5225a2b836fba706a87e45759fdfc")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Supply)))
  "Returns md5sum for a message object of type 'Supply"
  "26f5225a2b836fba706a87e45759fdfc")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Supply>)))
  "Returns full string definition for message of type '<Supply>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Supply)))
  "Returns full string definition for message of type 'Supply"
  (cl:format cl:nil "Header header~%float32[] voltage~%float32[] current~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Supply>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Supply>))
