/* Auto-generated by genmsg_cpp for file /home/rosdev/fuerte_workspace/sandbox/tum_simulator/cvg_sim_msgs/msg/Altitude.msg */
...
{
template<class ContainerAllocator> struct IsMessage< ::cvg_sim_msgs::Altitude_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::cvg_sim_msgs::Altitude_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
...
template<class ContainerAllocator> struct HasHeader< ::cvg_sim_msgs::Altitude_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct HasHeader< const ::cvg_sim_msgs::Altitude_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
