"""autogenerated by genpy from cvg_sim_msgs/RawMagnetic.msg. Do not edit."""
import sys
...
class RawMagnetic(genpy.Message):
  ...
  _type = "cvg_sim_msgs/RawMagnetic"
...
"""
  ...
  _slot_types = ['std_msgs/Header','float64[3]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_3d.pack(*self.channel))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.channel = _struct_3d.unpack(str[start:end])
      return self
